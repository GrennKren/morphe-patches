 ...
 * Opening Files settings), the code falls through to other file type checks instead
 * of showing the "Open With" dialog. Text files should be opened externally when
 * the internal viewer is disabled.
 *
 * Key identifiers from APK decompilation:
